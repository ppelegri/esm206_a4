...
Visually explore relationship between juvenile weight and hind foot length
```{r}
ggplot(hares,
...
Explore linear regression relating juvenile weight and hind foot length
```{r}
# Run linear regression
hares_lm <- lm(hindft ~ weight, data = hares)
...
**Change all the below to be for hares**
