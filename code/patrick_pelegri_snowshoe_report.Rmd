...
## Juvenile snowshoe hare trap counts **Customize ggplot** **Insert takeaways**

**CUSTOMIZE GGPLOT** Count the total number of juvenile hare trappings during each year of the study and create a finalized data visualization of the counts by year.
...
**Change this to faceted graph like Sarah did - instead of table** 
...
## Male and female hare weight comparison
